...
namespace Shuvashish.Repository.UnitOfWork
{
    public class UnitOfWorkScope : IDisposable
    {
        ...
        private NorthwindEntities _objectContext;
        ...
        /// </summary>
        internal static NorthwindEntities CurrentObjectContext
        {
        ...
        public void Dispose()
        {
            ...
            /* End of scope, so clear the thread static _currentScope member: */
            _currentScope = null;
            Thread.EndThreadAffinity();
            if (_saveAllChangesAtEndOfScope) _objectContext.SaveChanges();
